...
class TTextTheme {
  TTextTheme._(); // Para evitar a criaçao de instancias
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    //Acent Colors Text
    // displayLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: Colors.white),
    // displayMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white),
    //displaySmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: Colors.white),
  );
